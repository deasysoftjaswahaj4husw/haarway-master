...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> dataJson) {
    ...
    print("jpdata $list.runtimeType");
    List<SocialLinks> resultList =
    list.map((i) => SocialLinks.fromJson(i)).toList();
    print(resultList);
    global.customerID = dataJson['customerID'];
    global.custmPass = dataJson['customer_Password'];
    String imgurl = dataJson['customer_profile_photo'];
    String custompf;
    if(!imgurl.contains("https"))
    {
      global.imageFileName = imgurl;
      String baseimgurl = "https://dy9k9gipgfk4q.cloudfront.net/upload/customer/original/";
      custompf = (baseimgurl+imgurl);
      global.imageURL = custompf;
      print("imageUrlName data==============::: $custompf");
    }
    else if(imgurl.contains("https")){
      custompf = imgurl;
      print("imageUrlName data2==============::: $custompf");
    }
    ...
    return Data(
        ...
        customer_profile_photo: custompf,
