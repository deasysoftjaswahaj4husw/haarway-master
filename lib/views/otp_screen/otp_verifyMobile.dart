...
class RequestItemOtpMob extends StatefulWidget {
  final String email;
  final String newEmail;
  final bool isGuestCheckOut;

  const RequestItemOtpMob({
    Key key,
    @required this.email,
    this.newEmail = "",
  ...
  @override
  _RequestItemOtpMobState createState() => new _RequestItemOtpMobState();
}

class _RequestItemOtpMobState extends State<RequestItemOtpMob>
    ...
    setState(() {
      ...
      if (_firstDigit == null) {
        ...
        Provider.of<ProviderModel>(context, listen: false)
            .requestItemOtpVerifyMob(otp, context, global.requestItem_otp_id);
