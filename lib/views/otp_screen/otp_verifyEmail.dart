...
class RequestItemOtpEmail extends StatefulWidget {
  final String email;
  final String newEmail;
  final bool isGuestCheckOut;

  const RequestItemOtpEmail({
    Key key,
  ...
  @override
  _RequestItemOtpEmailState createState() => new _RequestItemOtpEmailState();
}

class _RequestItemOtpEmailState extends State<RequestItemOtpEmail>
    ...
    setState(() {
      ...
      if (_firstDigit == null) {
        ...
        Provider.of<ProviderModel>(context, listen: false)
            .requestItemOtpVerifyEmail(otp, context, global.requestItem_otp_id);
